...
unsuccessful pass rush play: https://www.nfl.com/videos/teddy-bridgewater-courtland-sutton-barely-miss-out-on-chance-at-62-yard-td-bomb

Figure \ref{fig:fig_crosby_curves_unsucess}
...
#| fig.cap: "strain is more predictive of pressure rate than pressure rate itself."
#| fig.width: 6.5
#| fig.height: 3
#| fig.show: "hold"
...
Figure \ref{fig:fig_predictability} (0.09651732 vs 0.3216974)
...
\begin{table}
\caption{Fixed effects for the multilevel model. \label{tab:fixedeff}}
\centering
\begin{tabular}{rrrrrr}
  \hline
 & estimate & se & df & $t$-statistic & $p$-value \\ 
  \hline
Intercept & 0.355 & 0.010 & 332.288 & 35.688 & 0.000 \\ 
  play\_len & -0.004 & 0.000 & 30653.793 & -38.214 & 0.000 \\ 
  rush\_posDT & -0.081 & 0.008 & 369.713 & -10.340 & 0.000 \\ 
  rush\_posinteriorLB & 0.058 & 0.011 & 770.441 & 5.332 & 0.000 \\ 
  rush\_posNT & -0.106 & 0.012 & 355.999 & -9.173 & 0.000 \\ 
  rush\_posOLB & 0.062 & 0.008 & 388.506 & 7.695 & 0.000 \\ 
  rush\_possecondary & 0.145 & 0.012 & 1734.779 & 12.328 & 0.000 \\ 
  block\_posG & 0.011 & 0.006 & 123.672 & 1.867 & 0.064 \\ 
  block\_posother & 0.010 & 0.008 & 500.451 & 1.261 & 0.208 \\ 
  block\_posT & 0.023 & 0.006 & 161.556 & 3.625 & 0.000 \\ 
  n\_blockers & -0.064 & 0.003 & 30949.514 & -24.788 & 0.000 \\ 
   \hline
\end{tabular}
\end{table}
...
Figure \ref{fig:fig_rankings_boot} displays the mean varying intercept for the top ten pass rushers for each position along with 95% confidence intervals generated by sampling from the posterior distributions via parametric bootstrapping using the `merTools` package [@knowlesmerTools, @gelman2006data]. 
We observe similar rankings based on the random intercepts in comparison to the average STRAIN, with Myles Garrett (DE), Aaron Donald (DT), Vita Vea (NT), and T.J. Watt (OLB) as the top pass rushers. 
We observe different levels of variability across these top players, with the only a subset of players with intervals strictly above zero.  [NEED TO THINK ABOUT WHAT MORE TO SAY HERE]
