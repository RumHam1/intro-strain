...
This is an improvement over sacks, but suffers from problems of subjectivity (e.g., whether there is an actual hurry or not).
...
In addition, once a cutoff is chosen, this metric converts continuous data to a win-loss indicator, becoming binary like most of the metrics discussed above.
