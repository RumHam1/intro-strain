...
$$
\frac{\frac{(\# Hurries + \# Hits)}{2} + \# Sacks}{\#PassRush Snaps}
$$.
...
Time In Pocket (TIP) & The time from snap to throw or pocket collapse for a quarterback (https://www.pff.com/news/pro-pff-signature-statistics-a-glossary#:~:text=Time%20in%20Pocket,time%20until%20a%20quarterback%20scrambles)\\
Pass Rush Win Rate (PRWR) & Rate at which pass rusher beats pass block within 2.5 seconds after snap (https://www.espn.com/nfl/story/_/id/34536376/2022-nfl-pass-rushing-run-stopping-blocking-leaderboard-win-rate-rankings-top-players-teams)\\\hline
\end{tabular}
\end{center}
\end{table}
