...
```{r formation, fig.width=4.8, fig.height=3.5, fig.pos="t", fig.cap="Two common defensive alignments in football: 4-3 defense (top) and 3-4 defense (bottom). The dashed line represents the line of scrimmage separating the defense and offense."}
