...
However, for plays that do not result in the aforementioned outcomes (in particular, sack), there are still many intermediate defensive actions on the field within the play that are valuable and can be considered successes.

Moreover, the sum of sacks, hits, and hurries is often defined as pressures.
This is better than sacks to some extent, but suffers from problems of subjectivity (e.g., whether there is an actual hurry or not).
