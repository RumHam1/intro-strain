...
All of these measures represent different versions of "the best we can do with the available data".  Without granular data, it is difficult to measure effectiveness of a pass rusher so many simple metrics of success have been proposed. 
...
@AlamarGould2008 examine the the relationship between pass completion and offensive linemen's performance, in terms of how successful they were at blocking.
The data for this study are manually collected for the first three weeks of the 2007 NFL season, recording whether a lineman holds a block and the time in pocket for the quarterback.
