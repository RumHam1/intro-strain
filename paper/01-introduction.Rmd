...
Moreover, the sum of sacks, hits, and hurries is often defined as (QB) pressures.
This is somewhat better than sacks, but suffers from problems of subjectivity (e.g., whether there is an actual hurry or not).
