...
$$[ \ (\text{Hurries} + \text{Hits})/2 + \text{Sacks} \ ]\  / \text{ Pass Rush Snaps}$$
...
Pass-Rush Productivity & $[\ (\text{Hurries} + \text{Hits})/2 + \text{Sacks}\ ]\  / \text{ Pass Rush Snaps}$\\
...
[Pro football ref has different QB pressures formula? https://www.pro-football-reference.com/about/advanced_stats.htm]
