...
For each play, we have information on the on-field location, speed, angle, direction, and orientation of each player on the field and the football at a rate of 10 Hz (i.e. ten measurements per second), along with event annotations for each frame such as ball snap, pass forward, and quarterback sack, to name a few.
...
In this manuscript, we use the PFF data to identify 36,362 unique pass rushing attempts by players designated in the "pass rush" role across all plays.  <!-- Need to reword this.  There aren't 36,362 unique players.  It's like players by rushes or something like that.  -->
