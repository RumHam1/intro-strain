...
We demonstrated that a pass rusher's average STRAIN is both stable and more predictive of future pressure events than using the player's previously observed pressure events.
...
There is ample opportunity for working with the complete STRAIN trajectories via functional data analysis to better understand the impact of STRAIN on offensive production in American football.
