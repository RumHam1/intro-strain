...
This play is represented by Table [INSERT NUMBER - tracking data table] and Figure [INSERT NUMBER - line graph] in the paper.
...
Based on the clearly distinct patterns for different positions as previously observed, we evaluate interior pass rushers (NTs and DTs) separately from edge rushers (OLBs and DEs).
...
# Comparison of multilevel models for play-level STRAIN

## Model without team effects
