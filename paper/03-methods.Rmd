...
Since there can be multiple blockers linked to a rusher, for simplicity, we consider the nearest blocker positioned to the pass rusher at the start of the play.
