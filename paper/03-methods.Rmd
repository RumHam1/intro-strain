...
\end{equation*}
Notice that this measure is unitless due to being a ratio of two quantities having the same units.
...
Whereas strain has no units, the strain rate is measured in inverse of time, usually 1/seconds.
...
Formally, the average STRAIN, denoted by $\overline{\text{STRAIN}}$, for pass rusher $j$ involved in $n_j$ total plays across $\sum_{i\in Z_j} T_i$ total frames where $Z_j$ is a set of the play indices where player $j$ was involved is
\begin{equation*}
