...
\end{equation*}
This can be helpful for metric assessment, as we use average STRAIN to examine different statistical properties of our measure in Section \ref{sec:statprop}. 
