...
Our focus of this manuscript is specifically on measuring the performance of NFL defensive linemen (see Section A of the Supplement for more information on the defensive positions in football).
Using data made available in the Big Data Bowl 2023, we present a novel approach to measure the performance of pass rushers.
...
Table B.1 of the Supplement gives a summary of existing football metrics for pass rush.
...
Pro Football Focus (PFF) defines a metric called pass-rush productivity, which is a minor modification from the aforementioned pressures metric.
