...
Further, we recognize the limitation that our analysis did not account for the fact that play length can differ. Although we agree that this is an important consideration, which requires time-to-event modeling, since the main goal of this paper is to introduce STRAIN as a metric for evaluating pass rushers in football, we leave this problem for future work.**
